    ...
    <div className="card">
      ...
      <div id="financeiro-compra-venda" style={{ scrollMarginTop: 90 }}>
        ...
        <ol style={OL}>
          ...
          <li>Filtre por categoria, proprietário e/ou lote, e marque os animais (ou "Selecionar todos do filtro"). O seletor de categoria tem uma opção extra, <strong>"Vacas falhadas"</strong>: mostra as matrizes que não entregaram terneiro na <strong>última estação de monta</strong> (não emprenhou, abortou ou teve perda gestacional presumida — qualquer que seja o motivo; quem pariu não é falhada, mesmo tendo falhado numa tentativa anterior da mesma estação, e vaca em repasse também não conta como falhada). Fica desabilitada por um instante enquanto o histórico reprodutivo carrega, na primeira vez que você abre o formulário de venda.</li>
