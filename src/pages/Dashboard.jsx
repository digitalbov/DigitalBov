...
const MODULES = [
  { path:'/propriedade', icon:'ti-home-2',         label:'Propriedade',          sub:'Fazenda, piquetes e lotes',       bg:'#EAF3DE', color:'#27500A' },
  ...
  { path:'/sanidade',    icon:'ti-shield-check',    label:'Sanidade',             sub:'Vacinas e procedimentos',         bg:'#EAF3DE', color:'#27500A' },
  ...
  { path:'/financeiro',  icon:'ti-cash',            label:'Gestão Financeira',    sub:'Receitas e despesas',             bg:'#EAF3DE', color:'#27500A' },
]
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:16 }}>
          <img src="/logo-circular.png" style={{width:90, height:90, objectFit:'contain', borderRadius:'50%', background:'white', padding:3, flexShrink:0}} alt="Logo"/>
          <div>
      ...
      <div className="kpi-grid">
        {[
          { value: filtAnimais.length,                             label:'Total de animais',     sub:'Ativos',                    icon:'ti-chart-bar',    bg:'#EAF3DE', color:'#27500A' },
      ...
      <div className="grid-2" style={{ marginBottom:16 }}>
        ...
        <div>
          ...
          <div className="grid-3" style={{ marginBottom:12 }}>
            ...
            <IndexCard value={prenhas}        label="Prenhas"          color="#1E4D35" />
            <IndexCard value={matrizes}       label="Matrizes"         color="#1E4D35" />
          </div>
          ...
          <div className="grid-3">
            {[
              { label:'Receitas',  value:fmtMoeda(rec),  color:'#27500A' },
              { label:'Despesas',  value:fmtMoeda(desp), color:'#791F1F' },
              { label:'Resultado', value:fmtMoeda(resu), color: resu>=0?'#1E4D35':'#791F1F' },
            ].map(f => (
          ...
          <div className="card" style={{ borderTop:'3px solid #0C447C' }}>
            ...
            <div style={{ display:'flex', gap:12, flexWrap:'wrap', marginBottom:12 }}>
              <div style={{ background:'#F9FAFB', border:'.5px solid #E5E7EB', borderRadius:8, padding:'8px 14px' }}>
                ...
                <div style={{ fontWeight:700, color:'#1E4D35' }}>{acoesConcl}/{acoesConcl+acoesPend}</div>
              </div>
              {acoesCiclo.length > 0 && (
