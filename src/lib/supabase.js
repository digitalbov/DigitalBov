...
export const db = {
  ...
  animais: {
    ...
    insert:   (data)  => supabase.from('animais').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  proprietarios: {
    ...
    insert:  (data)   => supabase.from('proprietarios').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  lotes: {
    ...
    insert: (data)   => supabase.from('lotes').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  piquetes: {
    ...
    insert: (data)   => supabase.from('piquetes').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  lotesInseminacao: {
    ...
    insert: (data)   => supabase.from('lotes_inseminacao').insert({ ...data, fazenda_id: fid() }).select().single(),
    update: (id, d)  => supabase.from('lotes_inseminacao').update(d).eq('id', id).select().single()
  },

  inseminacoes: {
    insert:  (data)       => supabase.from('inseminacoes').insert(data),
  ...
  partos: {
    ...
    insert:    (data)      => supabase.from('partos').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  pesagens: {
    ...
    insert:  (data) => supabase.from('pesagens').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  sanidade: {
    ...
    insert: (data) => supabase.from('procedimentos_sanitarios').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  estoque: {
    ...
    insert: (data)  => supabase.from('estoque_itens').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  movEstoque: {
    ...
    insert: (data) => supabase.from('estoque_movimentacoes').insert({ ...data, fazenda_id: fid() }).select().single()
  },
  ...
  lancamentos: {
    ...
    insert: (data) => supabase.from('lancamentos_financeiros').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  transacoes: {
    ...
    insert: (data) => supabase.from('transacoes_animais').insert({ ...data, fazenda_id: fid() }).select().single()
  },
  ...
  ciclos: {
    ...
    insert:        (data) => supabase.from('ciclos_financeiros').insert({ ...data, fazenda_id: fid() }).select().single(),
    deactivateAll: ()     => {
  ...
  planejamentos: {
    ...
    insert: (data) => supabase.from('planejamentos').insert({ ...data, fazenda_id: fid() }).select().single(),
  ...
  planejamentoAcoes: {
    ...
    insert: (data)   => supabase.from('planejamento_acoes').insert(data).select().single(),
